...
public abstract class MediaCodecRenderer extends BaseRenderer {
  ...
  protected void onPositionReset(long positionUs, boolean joining) throws ExoPlaybackException {
    log.i("onPositionReset: "+ positionUs + ", joining: " + joining); // AMZN_CHANGE_ONELINE
  ...
  private boolean feedInputBuffer() throws ExoPlaybackException {
    ...
    if (waitingForKeys) {
      log.i("We've already read an encrypted sample into sampleHolder, and are waiting for keys"); // AMZN_CHANGE_ONELINE
    ...
    if (waitingForKeys) {
      log.i("Waiting For Keys!!!"); // AMZN_CHANGE_ONELINE
      return false;
    }
